...
ChatLogic::ChatLogic()
{
    //// Removed the responsibility of memory allocation for chatbot
    ////

    // create instance of chatbot
   // _chatBot = new ChatBot("../images/chatbot.png"); --> not necessary anymore
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
        ...
        while (getline(file, lineStr))
        {
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        //// Adapted node to unique pointer
                        ////
    ...
    ////Adapted Iterator to match with exclusive ownership
    ////
